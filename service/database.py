...
DB_URL = "postgresql://rutas:rutas123@localhost:5432/rutas"


async def save_routes_to_db(result: SolverResult) -> None:
    """
    ...
    # -------------------------------------------------------------------------
    # MODO DUMMY — descomentar si no hay contenedor PostgreSQL disponible
    # -------------------------------------------------------------------------
